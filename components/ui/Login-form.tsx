        ...
        <div className="w-full max-w-md space-y-8">
            ...
            <form className="mt-8 space-y-6">
                ...
                <div className='flex items-center justify-center md:pt-10'>
                    <p>Don&apos;t have an account? <Link href={`/auth/signup?callbackUrl=${callbackUrl}`} className="hover:underline text-sm text-white hover:text-gray-300 font-bold">Create One</Link></p>
                </div>
            </form>
        </div>
    )
